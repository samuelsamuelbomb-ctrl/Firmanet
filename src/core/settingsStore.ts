/**
 * Settings store — reactive settings for both web and native.
 *
 * Persists to localStorage on web, AsyncStorage on native.
...
export function intensityToSoundLevel(intensity: IntensityId): Intensity {
  switch (intensity) {
    case "minimal":
      return "danger";
    case "balanced":
